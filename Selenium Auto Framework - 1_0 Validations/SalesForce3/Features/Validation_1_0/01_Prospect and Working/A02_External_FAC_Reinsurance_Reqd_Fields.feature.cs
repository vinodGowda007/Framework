...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A02_External_FAC_Reinsurance_Reqd_Fields")]
    public partial class A02_External_FAC_Reinsurance_Reqd_FieldsFeature
    {
...
#line 1 "A02_External_FAC_Reinsurance_Reqd_Fields.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A02_External_FAC_Reinsurance_Reqd_Fields", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("HPQC 454 / 802 - make Basis Of Acceptance, and Policy Ceding Commission Amount, F" +
            "AC Reinsurance Gross Premium required when FAC Reinsurance is set to Yes.")]
        ...
        public void HPQC454802_MakeBasisOfAcceptanceAndPolicyCedingCommissionAmountFACReinsuranceGrossPremiumRequiredWhenFACReinsuranceIsSetToYes_(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("HPQC 454 / 802 - make Basis Of Acceptance, and Policy Ceding Commission Amount, F" +
                    "AC Reinsurance Gross Premium required when FAC Reinsurance is set to Yes.", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("User Updated \'FAC Basis of Acceptance,FAC RI PRM,Policy Ceding Commission Amount\'" +
...
#line hidden
#line 20
 testRunner.Then("Verify the Error messages for Backtracking as \"When Purchased External FAC Reinsu" +
                        "rance is Yes, following fields cannot be blank. - Basis Of Acceptance - Policy C" +
                        "eding Commission Amount - FAC Reinsurance Gross Premium\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
