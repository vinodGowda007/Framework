...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A128_FAC_RI_PRM_UCB_Pol_Ced_Comm_UCB")]
    public partial class A128_FAC_RI_PRM_UCB_Pol_Ced_Comm_UCBFeature
    {
...
#line 1 "A128_FAC_RI_PRM_UCB_Pol_Ced_Comm_UCB.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A128_FAC_RI_PRM_UCB_Pol_Ced_Comm_UCB", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("01  If the Purchase External FAC UCB is Yes, FAC RI PRM UCB, Pol Ced Comm UCB is " +
            "required. 1.0")]
        ...
        public void _01IfThePurchaseExternalFACUCBIsYesFACRIPRMUCBPolCedCommUCBIsRequired_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01  If the Purchase External FAC UCB is Yes, FAC RI PRM UCB, Pol Ced Comm UCB is " +
                    "required. 1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("User Updated \'Purchase External FAC (UCB),Underwriting Credit Branch\' field", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 19
...
#line hidden
#line 20
 testRunner.Then("Verify the Error messages for Backtracking as \"If the Purchase External FAC UCB i" +
                        "s Yes, FAC RI PRM UCB, Pol Ced Comm UCB are required. ( SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
