...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A50_ST_Create_New_Submission")]
    public partial class A50_ST_Create_New_SubmissionFeature
    {
...
#line 1 "A50_ST_Create_New_Submission.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A50_ST_Create_New_Submission", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Stage is not valid during initial creation of the Submission. ( Submission Detail" +
            "s Tab )")]
        ...
        public void StageIsNotValidDuringInitialCreationOfTheSubmission_SubmissionDetailsTab(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Stage is not valid during initial creation of the Submission. ( Submission Detail" +
                    "s Tab )", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("Verify the Error messages for Backtracking as \"ICE Status cannot be Unchecked on " +
                        "the Submission and Client$Stage is not valid during initial creation of the Subm" +
                        "ission. ( Submission Details Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
