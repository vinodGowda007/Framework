...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A132_Purchase_Ext_UCCB_No")]
    public partial class A132_Purchase_Ext_UCCB_NoFeature
    {
...
#line 1 "A132_Purchase_Ext_UCCB_No.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A132_Purchase_Ext_UCCB_No", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("01  If Purchase External UCB is No, FAC RI PRM UCB and Pol Ced Comm UCB should be" +
            " blank 1.0")]
        ...
        public void _01IfPurchaseExternalUCBIsNoFACRIPRMUCBAndPolCedCommUCBShouldBeBlank1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01  If Purchase External UCB is No, FAC RI PRM UCB and Pol Ced Comm UCB should be" +
                    " blank 1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 19
 testRunner.Then("User Updated \'Underwriting Credit Branch\' field with values \'Reset Picklist\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 20
...
#line hidden
#line 21
 testRunner.Then("Verify the Error messages for Backtracking as \"Underwriting Credit Branch is requ" +
                        "ired if UCB Share % OR Purchase External FAC UCB is Yes/No OR if the production " +
                        "office or issuing office is Middle Market ( SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
