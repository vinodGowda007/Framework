...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A168_ProducerContact")]
    public partial class A168_ProducerContactFeature
    {
...
#line 1 "A168_ProducerContact.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A168_ProducerContact", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Any Submissions associated with Japan should be using the generic Producer Contac" +
            "t “Japan Contact,” (UW/Producer Tab) please update accordingly. Open a Remedy ti" +
            "cket if you are still experiencing issues.")]
        ...
        public void AnySubmissionsAssociatedWithJapanShouldBeUsingTheGenericProducerContactJapanContactUWProducerTabPleaseUpdateAccordingly_OpenARemedyTicketIfYouAreStillExperiencingIssues_(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Any Submissions associated with Japan should be using the generic Producer Contac" +
                    "t “Japan Contact,” (UW/Producer Tab) please update accordingly. Open a Remedy ti" +
                    "cket if you are still experiencing issues.", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 26
 testRunner.Then("User Updated \'Licensed Producer,Placing Producer Contact\' field with values \'JLT " +
                        "Japan Limited,Starr Japan\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 27
...
#line hidden
#line 28
 testRunner.Then("Verify the Error messages for Backtracking as \"Any Submissions associated with Ja" +
                        "pan should be using the generic Producer Contact “Japan Contact,” (UW/Producer T" +
                        "ab) please update accordingly. Open a Remedy ticket if you are still experiencin" +
                        "g issues.\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
