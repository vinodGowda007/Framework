...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A41_Producer_Validation")]
    public partial class A41_Producer_ValidationFeature
    {
...
#line 1 "A41_Producer_Validation.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A41_Producer_Validation", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Either the Producer is not Active or the Producer is not Approved for this Agency" +
            ". ( UW and Producer Info Tab )")]
        ...
        public void EitherTheProducerIsNotActiveOrTheProducerIsNotApprovedForThisAgency_UWAndProducerInfoTab(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Either the Producer is not Active or the Producer is not Approved for this Agency" +
                    ". ( UW and Producer Info Tab )", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("User Updated \'Licensed Producer\' field with values \'Raney Insurance And Bonding\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 19
...
#line hidden
#line 20
 testRunner.Then("Verify the Error messages for Backtracking as \"Either the Producer is not Active " +
                        "or the Producer is not Approved for this Agency. ( UW and Producer Info Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
