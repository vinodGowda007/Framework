Feature: A144_SCIGLMisc_Subclass1_required
...
# Validation Rule : A144_SCIGLMisc_Subclass1_required
	Then User Clicked on "Edit" button
	Then User Updated 'Line of Business,Issuing Office,Subclass 1' field with values 'Construction,Atlanta,MAJOR'
