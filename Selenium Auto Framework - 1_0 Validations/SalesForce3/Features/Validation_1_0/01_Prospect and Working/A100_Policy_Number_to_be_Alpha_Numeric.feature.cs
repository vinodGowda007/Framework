...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A100_Policy_Number_to_be_Alpha_Numeric")]
    public partial class A100_Policy_Number_To_Be_Alpha_NumericFeature
    {
...
#line 1 "A100_Policy_Number_to_be_Alpha_Numeric.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A100_Policy_Number_to_be_Alpha_Numeric", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Policy number needs to be alpha numeric without any special characters.1.0")]
        ...
        public void PolicyNumberNeedsToBeAlphaNumericWithoutAnySpecialCharacters_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Policy number needs to be alpha numeric without any special characters.1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("User Updated \'Policy Number - Current,Local Policy Number – Current,Local Policy " +
                        "Number – Expiring\' field", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 19
...
#line hidden
#line 20
 testRunner.Then(@"Verify the Error messages for Backtracking as ""Policy Number and Local Policy Number, Local Policy Number Current, and Expiring have to be alpha numeric and cannot contain special characters. - Field ( Policy Number - Current, Local Policy Number, current and expiring : Submission Details Tab )""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
