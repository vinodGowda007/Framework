...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A19_MAS_Required")]
    public partial class A19_MAS_RequiredFeature
    {
...
#line 1 "A19_MAS_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A19_MAS_Required", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Required if Carrier Branch = Singapore OR if Issuing Company = Starr Internationa" +
            "l Insurance (Singapore) Pte. Ltd.1.0")]
        ...
        public void RequiredIfCarrierBranchSingaporeORIfIssuingCompanyStarrInternationalInsuranceSingaporePte_Ltd_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Required if Carrier Branch = Singapore OR if Issuing Company = Starr Internationa" +
                    "l Insurance (Singapore) Pte. Ltd.1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 39
 testRunner.Then("User Updated \'Carrier Branch,MAS\' field with values \'Singapore,--None--\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 40
...
#line hidden
#line 41
 testRunner.Then("Verify the Error messages for Backtracking as \"Required when Carrier Branch is Si" +
                        "ngapore Or Issuing Company is Starr International Insurance (Singapore) Pte. Ltd" +
                        ". - Field ( MAS - Submission Details Tab)\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 42
