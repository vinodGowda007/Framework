...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A67_STNA_Effective_Date_Validation")]
    public partial class A67_STNA_Effective_Date_ValidationFeature
    {
...
#line 1 "A67_STNA_Effective_Date_Validation.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A67_STNA_Effective_Date_Validation", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Effective Date should never be after Expiration Date. Expiration Date can be equa" +
            "l to Expiration date if it is Flat Cancellation.Else Effective Date must be less" +
        ...
        public void EffectiveDateShouldNeverBeAfterExpirationDate_ExpirationDateCanBeEqualToExpirationDateIfItIsFlatCancellation_ElseEffectiveDateMustBeLessThanExpirationDate(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Effective Date should never be after Expiration Date. Expiration Date can be equa" +
                    "l to Expiration date if it is Flat Cancellation.Else Effective Date must be less" +
                    " than Expiration Date", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 19
 testRunner.Then("User Updated \'Effective Date\' field with values \'Date\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 20
...
#line hidden
#line 21
 testRunner.Then("Verify the Error messages for Backtracking as \"Effective Date must be less than E" +
                        "xpiration Date ( Dates/Additional Info Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
