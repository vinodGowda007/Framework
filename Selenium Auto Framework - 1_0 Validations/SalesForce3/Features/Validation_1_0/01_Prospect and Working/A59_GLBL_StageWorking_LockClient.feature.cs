...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A59_GLBL_StageWorking_LockClient")]
    public partial class A59_GLBL_StageWorking_LockClientFeature
    {
...
#line 1 "A59_GLBL_StageWorking_LockClient.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A59_GLBL_StageWorking_LockClient", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Updates on locked fields are not allowed at this stage.- Client ( Submission Deta" +
            "ils Tab )")]
        ...
        public void UpdatesOnLockedFieldsAreNotAllowedAtThisStage_ClientSubmissionDetailsTab(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Updates on locked fields are not allowed at this stage.- Client ( Submission Deta" +
                    "ils Tab )", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 27
 testRunner.Then("User Updated \'Client Name\' field with values \'New Client Value\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 28
...
#line hidden
#line 29
 testRunner.Then(@"Verify the Error messages for Backtracking as ""Updates on locked fields are not allowed at this stage. - Client ( Submission Details Tab )$Updates on locked fields are not allowed at this stage. ( Submission Details Tab ) - Client - Parent Submission - LOB""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
