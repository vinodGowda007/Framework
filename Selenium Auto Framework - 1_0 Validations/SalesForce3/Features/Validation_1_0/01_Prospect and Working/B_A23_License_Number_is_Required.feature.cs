...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("B_A23_License_Number_is_Required")]
    public partial class B_A23_License_Number_Is_RequiredFeature
    {
...
#line 1 "B_A23_License_Number_is_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "B_A23_License_Number_is_Required", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("It is required at Bound when the Issuing Company is Starr Surplus Lines Insurance" +
            " Company")]
        ...
        public void ItIsRequiredAtBoundWhenTheIssuingCompanyIsStarrSurplusLinesInsuranceCompany(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("It is required at Bound when the Issuing Company is Starr Surplus Lines Insurance" +
                    " Company", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 19
 testRunner.Then("User Updated \'*Client Name\' field with values \'Validation Client\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 20
...
#line hidden
#line 31
 testRunner.Then("User Updated \'Issuing Company,License Number\' field with values \'Starr Surplus Li" +
                        "nes Insurance Company,Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 32
 testRunner.Then("User clicked on Save button in submission page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
#line 44
 testRunner.Then("Verify the Error messages for Backtracking as \"License Number is Required at Boun" +
                        "d Stage ( UW and Producer Info Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
