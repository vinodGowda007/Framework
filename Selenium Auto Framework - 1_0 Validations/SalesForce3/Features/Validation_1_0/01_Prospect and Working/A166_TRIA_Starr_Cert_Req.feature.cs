...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A166_TRIA_Starr_Cert_Req")]
    public partial class A166_TRIA_Starr_Cert_ReqFeature
    {
...
#line 1 "A166_TRIA_Starr_Cert_Req.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A166_TRIA_Starr_Cert_Req", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("When both field is filled Starr TRIA or Non Cert Premium then TRIA field is requi" +
            "red. 1.0")]
        ...
        public void WhenBothFieldIsFilledStarrTRIAOrNonCertPremiumThenTRIAFieldIsRequired_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("When both field is filled Starr TRIA or Non Cert Premium then TRIA field is requi" +
                    "red. 1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line 21
 testRunner.Then("User Updated \'TRIA/Non Cert Included,Starr TRIA Premium,Starr Non Cert Premium\' f" +
                        "ield with values \'No,1234,12355\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 22
...
#line hidden
#line 23
 testRunner.Then("Verify the Error messages for Backtracking as \"TRIA/Non Cert Included field must " +
                        "be populated to yes ,If Starr TRIA or Non Cert Premium is not empty ( TRIA/Non C" +
                        "ert Included : Policy Info )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 24
