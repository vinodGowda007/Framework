...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A110_Forecast_FAC_RI_PRM_Is_Required")]
    public partial class A110_Forecast_FAC_RI_PRM_Is_RequiredFeature
    {
...
#line 1 "A110_Forecast_FAC_RI_PRM_Is_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A110_Forecast_FAC_RI_PRM_Is_Required", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("if “Forecast FAC RI PRM” OR “FAC RI PRM” OR “Policy Ceding Commission Amount” fie" +
            "ld is populated the Purchased External FAC Reinsurance field should be Yes 1.0")]
        ...
        public void IfForecastFACRIPRMORFACRIPRMORPolicyCedingCommissionAmountFieldIsPopulatedThePurchasedExternalFACReinsuranceFieldShouldBeYes1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("if “Forecast FAC RI PRM” OR “FAC RI PRM” OR “Policy Ceding Commission Amount” fie" +
                    "ld is populated the Purchased External FAC Reinsurance field should be Yes 1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 18
 testRunner.Then("User Updated \'Policy Ceding Commission Amount,FAC RI PRM,Purchased External FAC R" +
                        "einsurance,Forecast FAC RI PRM\' field with values \'Random,Random,--None--,Random" +
...
#line hidden
#line 20
 testRunner.Then("Verify the Error messages for Backtracking as \"“FAC Premium, Ceding Commission, a" +
                        "nd/or Forecast FAC RI PRM has been populated, but the Purchased External FAC Rei" +
                        "nsurance indicator has not been selected, please review”\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 21
