...
namespace SaleForce3.Features.Validation_1_0._01_ProspectAndWorking
{
    ...
    [NUnit.Framework.DescriptionAttribute("A124_Underwriting_Credit_Branch")]
    public partial class A124_Underwriting_Credit_BranchFeature
    {
...
#line 1 "A124_Underwriting_Credit_Branch.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/01_Prospect and Working", "A124_Underwriting_Credit_Branch", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Underwriting Credit Branch is required if the production office is Middle Market." +
            "1.0")]
        ...
        public void UnderwritingCreditBranchIsRequiredIfTheProductionOfficeIsMiddleMarket_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Underwriting Credit Branch is required if the production office is Middle Market." +
...
#line hidden
#line 21
 testRunner.Then("Verify the Error messages for Backtracking as \"If Purchased External FAC (UCB) = " +
                        "No then the FAC RI PRM(UCB) and Policy Ceding Commission(UCB) should be blank. (" +
                        " SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
