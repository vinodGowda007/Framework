...
namespace SaleForce3.Features.Validation_1_0._02_Quoted
{
    ...
    [NUnit.Framework.DescriptionAttribute("A65_ST_Validate_Locked_Fields_Quoted")]
    public partial class A65_ST_Validate_Locked_Fields_QuotedFeature
    {
...
#line 1 "A65_ST_Validate_Locked_Fields_Quoted.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/02_Quoted", "A65_ST_Validate_Locked_Fields_Quoted", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Updates on locked fields are not allowed at \"Working\" stage")]
        ...
        public void UpdatesOnLockedFieldsAreNotAllowedAtWorkingStage(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Updates on locked fields are not allowed at \"Working\" stage", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 32
 testRunner.Then("User Updated the Client to check the Validaiton - \'A65_ST_Validate_Locked_Fields_" +
                        "Quoted\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 33
...
#line hidden
#line 34
 testRunner.Then("Verify the Error messages for Backtracking as \"Updates on locked fields are not a" +
                        "llowed at this stage. - Client - Parent Submission - Expiring Policy Number - Lo" +
                        "cal Policy Number - Expiring - Expiring Policy Number\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
