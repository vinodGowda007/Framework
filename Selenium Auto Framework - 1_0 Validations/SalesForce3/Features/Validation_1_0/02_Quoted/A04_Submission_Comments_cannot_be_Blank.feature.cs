...
namespace SaleForce3.Features.Validation_1_0._02_Quoted
{
    ...
    [NUnit.Framework.DescriptionAttribute("A04_Submission_Comments_cannot_be_Blank")]
    public partial class A04_Submission_Comments_Cannot_Be_BlankFeature
    {
...
#line 1 "A04_Submission_Comments_cannot_be_Blank.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/02_Quoted", "A04_Submission_Comments_cannot_be_Blank", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Submission Comments cannot be Blank when the Reason is one of the following (Cove" +
            "rage, Other, Terms/Conditions)")]
        ...
        public void SubmissionCommentsCannotBeBlankWhenTheReasonIsOneOfTheFollowingCoverageOtherTermsConditions(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Submission Comments cannot be Blank when the Reason is one of the following (Cove" +
                    "rage, Other, Terms/Conditions)", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 30
 testRunner.When("User performed Stage progression from \"Quoted\" to \"Lost/NTU\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 31
 testRunner.Then("User Updated \'LostNTU or Declined Reason,Submission Comments\' field with values \'" +
                        "Coverage (Provide Details in Submission Comments Section),Null\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 32
...
#line hidden
#line 33
 testRunner.Then("Verify the Error messages for Backtracking as \"Submission Comments cannot be Blan" +
                        "k when the Reason is either Coverage or Other or Terms/Conditions ( Submission D" +
                        "etails Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 34
...
#line 40
 testRunner.Then("User Updated \'LostNTU or Declined Reason,Submission Comments\' field with values \'" +
                        "Other (Provide Details in Submission Comments Section),Null\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 41
 testRunner.Then("User clicked on Save button during Edit Mode in Stage Progression for backtrackin" +
                        "g", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line 49
 testRunner.Then("User Updated \'LostNTU or Declined Reason,Submission Comments\' field with values \'" +
                        "Terms/Conditions (Provide details in Submission Comments section),Null\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 50
 testRunner.Then("User clicked on Save button during Edit Mode in Stage Progression for backtrackin" +
                        "g", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
