Feature: A65_ST_Validate_Locked_Fields_Quoted
...
# Verify Submission Quoted
	Then User Verified submission record status changed to "Quoted"

# Validation : A65_ST_Validate_Locked_Fields_Quoted
	Then User capture the value of 'Starr EPI/GWP'
	Then User Clicked on "Edit" button
	Then User Updated the Client to check the Validaiton - 'A65_ST_Validate_Locked_Fields_Quoted'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "Updates on locked fields are not allowed at this stage. - Client - Parent Submission - Expiring Policy Number - Local Policy Number - Expiring - Expiring Policy Number"
