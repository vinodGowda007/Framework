...
namespace SaleForce3.Features.Validation_1_0._02_Quoted
{
    ...
    [NUnit.Framework.DescriptionAttribute("A49_ST_Create_New_Endorsements")]
    public partial class A49_ST_Create_New_EndorsementsFeature
    {
...
#line 1 "A49_ST_Create_New_Endorsements.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/02_Quoted", "A49_ST_Create_New_Endorsements", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Required for Bound stage - Field ( Framework ST Risk Code - Policy Information Ta" +
            "b - Framework ST Risk Code )")]
        ...
        public void RequiredForBoundStage_FieldFrameworkSTRiskCode_PolicyInformationTab_FrameworkSTRiskCode(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Required for Bound stage - Field ( Framework ST Risk Code - Policy Information Ta" +
                    "b - Framework ST Risk Code )", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 32
 testRunner.Then("User Update the Declined Reason in the submission", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 33
 testRunner.Then("User clicked on Save button in submission page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 34
 testRunner.Then("User Verified submission record status changed to \"Lost/NTU\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 35
...
#line hidden
#line 45
 testRunner.When("User performed Stage progression from \"Lost/NTU\" to \"Quoted\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 46
 testRunner.Then("User clicked on Save button in submission page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
