...
namespace SaleForce3.Features.Validation_1_0._02_Quoted
{
    ...
    [NUnit.Framework.DescriptionAttribute("A68_WrittenShareReqWhenQuotedOrBound")]
    public partial class A68_WrittenShareReqWhenQuotedOrBoundFeature
    {
...
#line 1 "A68_WrittenShareReqWhenQuotedOrBound.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/02_Quoted", "A68_WrittenShareReqWhenQuotedOrBound", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Policy Premium Written Share % has to be between +100 or -100")]
        ...
        public void PolicyPremiumWrittenShareHasToBeBetween100Or_100(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Policy Premium Written Share % has to be between +100 or -100", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 31
 testRunner.Then("User Updated \'Policy Premium Written Share %\' field", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 32
...
#line hidden
#line 33
 testRunner.Then("Verify the Error messages for Backtracking as \"Policy Premium Written Share % is " +
                        "required and must be between +/- 100% ( Premium and Limits Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
