...
namespace SaleForce3.Features.Validation_1_0._02_Quoted
{
    ...
    [NUnit.Framework.DescriptionAttribute("A14_Forecast_Premium_Required")]
    public partial class A14_Forecast_Premium_RequiredFeature
    {
...
#line 1 "A14_Forecast_Premium_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/02_Quoted", "A14_Forecast_Premium_Required", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("If Issuing Office = Middle market then Production Office CANNOT equal Middle Mark" +
            "et(Detail-tab)")]
        ...
        public void IfIssuingOfficeMiddleMarketThenProductionOfficeCANNOTEqualMiddleMarketDetail_Tab(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("If Issuing Office = Middle market then Production Office CANNOT equal Middle Mark" +
                    "et(Detail-tab)", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 24
 testRunner.Then("User Updated \'Starr Share Estimated Forecast Premium\' field", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 25
...
#line hidden
#line 26
 testRunner.Then("Verify the Error messages for Backtracking as \"Forecast Premium is a required fie" +
                        "ld for all Stages, except for Prospect stage. ( Premium and Limits Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 27
