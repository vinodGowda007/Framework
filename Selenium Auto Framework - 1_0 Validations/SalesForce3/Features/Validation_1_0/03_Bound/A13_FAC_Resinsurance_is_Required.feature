Feature: A13_FAC_Resinsurance_is_Required
...
# Validation : A13_FAC_Resinsurance_is_Required
	Then User capture the value of 'Starr EPI/GWP'
	Then User Clicked on "Edit" button
	When User performed Stage progression from "Quoted" to "Bound"
	Then User Updated 'Purchased External FAC Reinsurance,FAC Basis of Acceptance,FAC RI PRM,Policy Ceding Commission Amount' field with values '--None--,--None--,"",""'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "Make sure the FAC Reinsurance on the parent and any corresponding Endorsements are selected. Field ( Purchased External FAC Reinsurance - Policy Information Tab )"
