Feature: A24_Lock_Subm_fields_from_Editing
...
#  Validation : A24_Lock_Subm_fields_from_Editing
	Then User Clicked on "Edit" button
	Then User Updated 'Endorsement Type' field with values '--None--'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "Parent Opportunity has to refer back to the original Policy for Endorsement, Section & Terrorism. As a rule, the following fields are locked for any modifications (Related Submission, Parent Submission, Endorsement Type) - Submission Details Tab"
