Feature: A35_Restrict_Fields_on_Bound_Stage
...
#  Validation : A35_Restrict_Fields_on_Bound_Stage
	Then User Clicked on "Edit" button
	Then User Updated 'LATAM Risk Code' field with values 'Random'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "In Bound Stage, following fields are locked for editing (Field List: Policy Number - Current, Policy Number Assignment Type, Issuing Company, Prefix, Carrier Branch, MAS, Assumed Insurer, Sign Date, Contracting Party, LATAM Risk Code, RUT # fields)"
