...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A127_Purchase_External_FAC_UCB")]
    public partial class A127_Purchase_External_FAC_UCBFeature
    {
...
#line 1 "A127_Purchase_External_FAC_UCB.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A127_Purchase_External_FAC_UCB", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("It is required if the UCB Share % is greater than 0% and if Underwriting credit b" +
            "ranch is populated.1.0")]
        ...
        public void ItIsRequiredIfTheUCBShareIsGreaterThan0AndIfUnderwritingCreditBranchIsPopulated_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("It is required if the UCB Share % is greater than 0% and if Underwriting credit b" +
                    "ranch is populated.1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 30
 testRunner.Then("User Updated \'Production Office Share %,UCB Share %,Purchase External FAC (UCB)\' " +
                        "field with values \'99,1,--None--\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 31
...
#line hidden
#line 32
 testRunner.Then("Verify the Error messages for Backtracking as \"Purchase External FAC UCB is requi" +
                        "red. ( SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
