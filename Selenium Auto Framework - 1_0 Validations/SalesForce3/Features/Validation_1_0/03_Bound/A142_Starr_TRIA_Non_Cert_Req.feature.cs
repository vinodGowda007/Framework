...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A142_Starr_TRIA_Non_Cert_Req")]
    public partial class A142_Starr_TRIA_Non_Cert_ReqFeature
    {
...
#line 1 "A142_Starr_TRIA_Non_Cert_Req.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A142_Starr_TRIA_Non_Cert_Req", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Either Starr TRIA or Non Cert Premium field must be populated if TRIA/Non Cert In" +
            "cluded = Yes OR TRIA fields cannot be updated once the submission has been fed t" +
            "o LYNX ( Starr TRIA, Non Cert Premium : Policy Info )")]
        ...
        public void EitherStarrTRIAOrNonCertPremiumFieldMustBePopulatedIfTRIANonCertIncludedYesORTRIAFieldsCannotBeUpdatedOnceTheSubmissionHasBeenFedToLYNXStarrTRIANonCertPremiumPolicyInfo(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Either Starr TRIA or Non Cert Premium field must be populated if TRIA/Non Cert In" +
                    "cluded = Yes OR TRIA fields cannot be updated once the submission has been fed t" +
                    "o LYNX ( Starr TRIA, Non Cert Premium : Policy Info )", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 23
 testRunner.Then("User Updated \'TRIA/Non Cert Included,Starr TRIA Premium,Starr Non Cert Premium\' f" +
                        "ield with values \'Yes,\"\",\"\"\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 24
...
#line hidden
#line 25
 testRunner.Then(@"Verify the Error messages for Backtracking as ""Either Starr TRIA or Non Cert Premium field must be populated if TRIA/Non Cert Included = Yes OR TRIA fields cannot be updated once the submission has been fed to LYNX ( Starr TRIA, Non Cert Premium : Policy Info )""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
