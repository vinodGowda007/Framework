...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A101_Amount_to_be_Zero_or_Negative")]
    public partial class A101_Amount_To_Be_Zero_Or_NegativeFeature
    {
...
#line 1 "A101_Amount_to_be_Zero_or_Negative.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A101_Amount_to_be_Zero_or_Negative", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 30
 testRunner.Then("User Updated \'100 Percent Policy Booked Premium\' field with values \'10\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 31
 testRunner.Then("User clicked on save button for validation", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 32
 testRunner.Then("Verify the Error messages for Backtracking as \"Please check EPI/GWP Premium and/o" +
                        "r Endorsement Type; as this specific Endorsement Type should return premium. - F" +
                        "ield ( Amount - Premium and Limits Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
