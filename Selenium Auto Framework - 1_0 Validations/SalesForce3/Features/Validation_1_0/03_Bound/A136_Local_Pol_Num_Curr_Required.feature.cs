...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A136_Local_Pol_Num_Curr_Required")]
    public partial class A136_Local_Pol_Num_Curr_RequiredFeature
    {
...
#line 1 "A136_Local_Pol_Num_Curr_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A136_Local_Pol_Num_Curr_Required", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 24
 testRunner.Then("User Updated \'Issuing Office,Local Policy Number – Current\' field with values \'Sa" +
                        "ntiago,Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 25
...
#line hidden
#line 26
 testRunner.Then("Verify the Error messages for Backtracking as \"Local Policy Number - Current is r" +
                        "equired in Bound for Santiago and Buenos Aires Offices. ( Submission Details Tab" +
