...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A01_Policy_No_Assignmnt_Type_ReqOn_Bound")]
    public partial class A01_Policy_No_Assignmnt_Type_ReqOn_BoundFeature
    {
...
#line 1 "A01_Policy_No_Assignmnt_Type_ReqOn_Bound.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A01_Policy_No_Assignmnt_Type_ReqOn_Bound", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 26
 testRunner.Then("User Updated \'Policy Number - Assignment Type,Policy Number - Current\' field with" +
                        " values \'--None--,Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 27
...
#line hidden
#line 28
 testRunner.Then(@"Verify the Error messages for Backtracking as ""Please ensure Policy Number and Policy Assignment Type have been populated; if they are and you're still experiencing issues; open a Remedy Ticket - ( Submission Details Tab )$Cannot change Policy Number, Issuing Company, Line of Business, Occupancy, Local Policy Number Current, Local Country and UDX Currency once the Stage has reached Bound. ( Submission Details Tab )""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
