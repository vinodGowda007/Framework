...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A26_Match_Policy_Number_for_Endorsements")]
    public partial class A26_Match_Policy_Number_For_EndorsementsFeature
    {
...
#line 1 "A26_Match_Policy_Number_for_Endorsements.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A26_Match_Policy_Number_for_Endorsements", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        public void LocalPolicyNumber_CurrentCannotBeModifiedInBoundOrCancelledStages_1_0(string scenarios, string recordType, string[] exampleTags)
        {
...
#line hidden
#line 30
 testRunner.Then("User Updated \'Policy Number - Current,Local Policy Number – Current\' field with v" +
                        "alues \'RandomNumbers\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 31
 testRunner.Then("User clicked on save button for validation", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 32
 testRunner.Then(@"Verify the Error messages for Backtracking as ""For Endorsements, Policy Number and Local Policy Number - Current should match with the Parent Submission's Policy Number, Local Pol Num - Fields ( Policy Number - Current, Local Policy Number - Current : - Submission Details Tab )""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
