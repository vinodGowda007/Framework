...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A35_Restrict_Fields_on_Bound_Stage")]
    public partial class A35_Restrict_Fields_On_Bound_StageFeature
    {
...
#line 1 "A35_Restrict_Fields_on_Bound_Stage.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A35_Restrict_Fields_on_Bound_Stage", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 29
 testRunner.Then("User Updated \'LATAM Risk Code\' field with values \'Random\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 30
...
#line hidden
#line 31
 testRunner.Then(@"Verify the Error messages for Backtracking as ""In Bound Stage, following fields are locked for editing (Field List: Policy Number - Current, Policy Number Assignment Type, Issuing Company, Prefix, Carrier Branch, MAS, Assumed Insurer, Sign Date, Contracting Party, LATAM Risk Code, RUT # fields)""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
