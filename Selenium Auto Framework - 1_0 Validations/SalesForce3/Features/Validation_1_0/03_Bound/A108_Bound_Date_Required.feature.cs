...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A108_Bound_Date_Required")]
    public partial class A108_Bound_Date_RequiredFeature
    {
...
#line 1 "A108_Bound_Date_Required.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A108_Bound_Date_Required", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Bound Date field under Submission Detail section should be required if issuing of" +
            "fice = Bratislava, Rotterdam, Budapest, or Zurich.1.0")]
        ...
        public void BoundDateFieldUnderSubmissionDetailSectionShouldBeRequiredIfIssuingOfficeBratislavaRotterdamBudapestOrZurich_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Bound Date field under Submission Detail section should be required if issuing of" +
                    "fice = Bratislava, Rotterdam, Budapest, or Zurich.1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 23
 testRunner.Then("User Updated \'Issuing Office\' field with values \'Prague\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 24
...
#line hidden
#line 25
 testRunner.Then("Verify the Error messages for Backtracking as \"Bound Date is required when Issuin" +
                        "g office is Bratislava, Budapest, Madrid, Malta, Munich, Prague, Rotterdam, or Z" +
                        "urich. ( Dates/Additional Info )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
