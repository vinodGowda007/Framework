...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A05_Bound_Reached_Cannot_Change_Fields")]
    public partial class A05_Bound_Reached_Cannot_Change_FieldsFeature
    {
...
#line 1 "A05_Bound_Reached_Cannot_Change_Fields.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A05_Bound_Reached_Cannot_Change_Fields", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Progressing stage from Quoted to Bound; Policy Number, Issuing Company, Line of B" +
            "usiness, Occ fields should be locked and uneditable \\.")]
        ...
        public void ProgressingStageFromQuotedToBoundPolicyNumberIssuingCompanyLineOfBusinessOccFieldsShouldBeLockedAndUneditable_(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Progressing stage from Quoted to Bound; Policy Number, Issuing Company, Line of B" +
                    "usiness, Occ fields should be locked and uneditable \\.", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 29
 testRunner.Then("User Updated \'Line of Business,Issuing Company,Occupancy,Division,Subclass 1,Prog" +
                        "ram\' field with values \'Random\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 30
...
#line hidden
#line 31
 testRunner.Then("Verify the Error messages for Backtracking as \"Cannot change Policy Number, Issui" +
                        "ng Company, Line of Business, Occupancy, Local Policy Number Current, Local Coun" +
                        "try and UDX Currency once the Stage has reached Bound. ( Submission Details Tab " +
