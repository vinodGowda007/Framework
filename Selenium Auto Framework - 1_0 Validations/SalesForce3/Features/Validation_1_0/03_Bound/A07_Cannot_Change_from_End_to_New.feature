Feature: A07_Cannot_Change_from_End_to_New
...
#  Validation : A07_Cannot_Change_from_End_to_New
	Then User Clicked on "Edit" button
	Then User Updated 'Submission Type' field with values 'New'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "Cannot change Type to New. ( Submission Details Tab )"
