...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A123_Production_Office_Share_Percentage")]
    public partial class A123_Production_Office_Share_PercentageFeature
    {
...
#line 1 "A123_Production_Office_Share_Percentage.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A123_Production_Office_Share_Percentage", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Production Office Share % is required at Working, Quoted, Bound and Cancelled sta" +
            "ges. It is defaulted to 100%. The Value needs to be in-between 0.1% and 100%. 1." +
            "0")]
        ...
        public void ProductionOfficeShareIsRequiredAtWorkingQuotedBoundAndCancelledStages_ItIsDefaultedTo100_TheValueNeedsToBeIn_Between0_1And100_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Production Office Share % is required at Working, Quoted, Bound and Cancelled sta" +
                    "ges. It is defaulted to 100%. The Value needs to be in-between 0.1% and 100%. 1." +
...
#line hidden
#line 21
 testRunner.Then("User Updated \'Production Office Share %\' field with values \'Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 22
...
#line hidden
#line 23
 testRunner.Then("Verify the Error messages for Backtracking as \"Production Office Share % must be " +
                        "greater than 0% and less than or equal to 100%. ( SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 24
