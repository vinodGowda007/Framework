...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A64_ST_User_MayNot_Modify_Field_Section")]
    public partial class A64_ST_User_MayNot_Modify_Field_SectionFeature
    {
...
#line 1 "A64_ST_User_MayNot_Modify_Field_Section.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A64_ST_User_MayNot_Modify_Field_Section", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 36
 testRunner.Then("User Updated \'Policy Number - Expiring\' field with values \'Random Values\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 37
...
#line hidden
#line 38
 testRunner.Then(@"Verify the Error messages for Backtracking as ""You may not modify the Related Submission Name, Parent Submission, Policy Number - Expiring, Local Policy Number Expiring (Submission Details ), Expired EPI, (Premium and Limits Tab ) on a Section.$You may not modify the Related Submission Name, Parent Submission, (Local) Policy Number - Expiring, Line of Business, Occupancy, or Subclass 1, 2, or 3 (Sub Details Tab), Expired EPI on an Endorsement or Renewal (or Renewal/Section for Global Offshore )""", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
