...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A137_Local_Pol_Num_Curr_Cant_be_Modified")]
    public partial class A137_Local_Pol_Num_Curr_Cant_Be_ModifiedFeature
    {
...
#line 1 "A137_Local_Pol_Num_Curr_Cant_be_Modified.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A137_Local_Pol_Num_Curr_Cant_be_Modified", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 41
 testRunner.Then("User Updated \'Issuing Office,Local Policy Number – Current\' field with values \'Lo" +
                        "ndon,Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 42
...
#line 43
 testRunner.Then("Verify the Error messages for Backtracking as \"Local Policy Number - Current cann" +
                        "ot be modified if the issuing or production office is in London and also if the " +
                        "type is endorsement or terrorism\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
