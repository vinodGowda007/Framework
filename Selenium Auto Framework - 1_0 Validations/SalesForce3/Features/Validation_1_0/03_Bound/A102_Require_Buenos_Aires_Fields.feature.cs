...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A102_Require_Buenos_Aires_Fields")]
    public partial class A102_Require_Buenos_Aires_FieldsFeature
    {
...
#line 1 "A102_Require_Buenos_Aires_Fields.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A102_Require_Buenos_Aires_Fields", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 28
 testRunner.Then("User Updated \'Client Name,Issuing Office,Licensed Producer\' field with values \'Te" +
                        "st_190,Buenos Aires,Aon Risk Solutions (München)\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 29
...
#line hidden
#line 30
 testRunner.Then("Verify the Error messages for Backtracking as \"Client\'s and Producer\'s C.U.I.T Nu" +
                        "mbers are required for Buenos Aires Issuing Office and Production Office before " +
                        "the Submission may be Bound.\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
