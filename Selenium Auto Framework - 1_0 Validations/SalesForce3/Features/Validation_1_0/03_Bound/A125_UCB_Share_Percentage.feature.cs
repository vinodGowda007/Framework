...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A125_UCB_Share_Percentage")]
    public partial class A125_UCB_Share_PercentageFeature
    {
...
#line 1 "A125_UCB_Share_Percentage.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A125_UCB_Share_Percentage", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("UCB Share % is required if the UCB is not blank. It is not required if the produc" +
            "tion office or issuing office is Middle Market. It has to greater or equal to 0%" +
            " and less than or equal to 100%. 1.0")]
        ...
        public void UCBShareIsRequiredIfTheUCBIsNotBlank_ItIsNotRequiredIfTheProductionOfficeOrIssuingOfficeIsMiddleMarket_ItHasToGreaterOrEqualTo0AndLessThanOrEqualTo100_1_0(string scenarios, string recordType, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("UCB Share % is required if the UCB is not blank. It is not required if the produc" +
                    "tion office or issuing office is Middle Market. It has to greater or equal to 0%" +
                    " and less than or equal to 100%. 1.0", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 22
 testRunner.Then("User Updated \'Underwriting Credit Branch,UCB Share %\' field with values \'--None--" +
                        ",Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 23
...
#line hidden
#line 24
 testRunner.Then("Verify the Error messages for Backtracking as \"UCB Share % must be between 0% and" +
                        " 100%. ( SGS Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 25
