Feature: A93_Invalid_Sales_Stage
...
#  Validation : A93_Invalid_Sales_Stage
	Then User Clicked on "Edit" button
	Then User Updated 'Stage' field with values 'Cancelled'
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "Not a Valid Sales Stage for Endorsement ( Submission Details Tab )"
