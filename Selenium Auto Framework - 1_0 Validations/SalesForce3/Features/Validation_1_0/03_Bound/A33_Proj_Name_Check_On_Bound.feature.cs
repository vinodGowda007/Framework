...
namespace SaleForce3.Features.Validation_1_0._03_Bound
{
    ...
    [NUnit.Framework.DescriptionAttribute("A33_Proj_Name_Check_On_Bound")]
    public partial class A33_Proj_Name_Check_On_BoundFeature
    {
...
#line 1 "A33_Proj_Name_Check_On_Bound.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Validation_1_0/03_Bound", "A33_Proj_Name_Check_On_Bound", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 23
 testRunner.Then("User Updated \'Project Name\' field with values \'Blank\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 24
...
#line hidden
#line 25
 testRunner.Then("Verify the Error messages for Backtracking as \"When Stage is moved to Bound, eith" +
                        "er Project Name has to be selected or the checkbox Check if no Project Name has " +
                        "to be checked. ( Submission Details Tab )\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
