Feature: A120_SCI_Renewal_LOB_OCC_Cannot_Update


@Sanity @Regression
Scenario: 	LOB and Occupancy Cannot be updated if the submission is a renewal. ( Submission Details Tab )
...
#  Validation : A120_SCI_Renewal_LOB_OCC_Cannot_Update
	Then User Clicked on "Edit" button
	Then User Updated the value for the field "Line of Business"
	Then User clicked on Save button during Edit Mode in Stage Progression for backtracking
	Then Verify the Error messages for Backtracking as "LOB and Occupancy Cannot be updated if the submission is a renewal. ( Submission Details Tab )"
...
Examples:
	...
	#| Scenario14 | SCI - Environmental          | for this record type only 1 lob is there, so we can not change the lob for this record type
